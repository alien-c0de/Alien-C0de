...
**Multi-Source IP Reputation Analysis Tool**  
Aggregates threat intelligence from 7+ sources (VirusTotal, AbuseIPDB, AlienVault OTX, etc.)  
...
SAST, secret scanning, dependency analysis & API vulnerability detection  
`DevSecOps` `CI/CD` `Security Automation` `Python`

---

### 🌐 [Web Matrix](https://github.com/alien-c0de/Web-Matrix)
**Reconnaissance & Security Assessment Tool**  
Automated web security analysis, network scanning, and vulnerability discovery  
...
<p align="center">
  ...
  <p align="center">
  <img src="https://github-profile-trophy.vercel.app/?username=alien-c0de&theme=darkhub&column=3&margin-w=4" alt="GitHub Trophies" width="48%" />
</p>
...
*"In the world of 1s and 0s, the best offense is a good exploit."*
